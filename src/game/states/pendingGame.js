...
PendingGame.prototype = {
  init: function (tilemapName, gameId) {
    ...
    game.add.sprite(0, 0, 'background_s');
		...
		this.startGameButton = game.add.button(buttonXOffset, startGameButtonYOffset, "start_game_button", null, this, 2, 2);
		...
		socket.on("startGameOnClient", this.startGame);
	},
	update: function() {},
    ...
    console.log("populateCharacterSquares", data);
		this.numPlayersInGame = 0;
